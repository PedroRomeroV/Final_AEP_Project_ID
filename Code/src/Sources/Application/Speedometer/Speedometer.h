...
#ifndef SPEEDOMETER_H                               /* To avoid double inclusion */
...
#define RADIUS_ANGLE 270
#define STEP_LIMIT_RANGE   (RADIUS_ANGLE*NUMBER_OF_STEPS)/360



void Speedometer_Init(void);
void Speedometer_Set(T_UWORD lub_Steps);
